...
public class RoomRestServiceImpl implements RoomRestService{
    ...
    public RoomResponseDTO createRoom(AddRoomRequestDTO dto) {
        // Find room type
        RoomType roomType = roomTypeRepository.findById(UUID.fromString(dto.getRoomTypeID()))
        ...
        // ✅ NEW: Let @PrePersist auto-generate UUID and name
        // Manual conversion DTO to Entity
        Room room = Room.builder()
                // .roomID() and .name() not set here - will be auto-generated by @PrePersist
    ...
    @Override
    public Room getRoomEntityById(UUID roomID) {
    ...
    @Override
    public List<RoomResponseDTO> getRoomsByRoomType(UUID roomTypeID) {
    ...
    @Override
    public List<RoomResponseDTO> getRoomsByPropertyAndFloor(UUID propertyID, Integer floor) {
   ...
   @Override
    public RoomResponseDTO updateRoom(UUID roomID, UpdateRoomRequestDTO dto) {
        Room room = roomRepository.findById(roomID)
                .orElseThrow(() -> new RuntimeException("Room not found with id: " + roomID));
...
// ===== Helper Methods =====
    ...
    //     String propertyID = roomType.getProperty().getPropertyID().toString();
    //     Integer floor = roomType.getFloor();
    //     
    //     System.out.println("🔑 Generating Room ID:");
    //     System.out.println("   Property ID: " + propertyID);
    //     System.out.println("   Floor: " + floor);
    //     System.out.println("   Room Type ID: " + roomType.getRoomTypeID().toString());
    //     
